...
const FOOTER_KEYWORDS =
	/^\s*(TOTALE|SUBTOTALE|SUB\s*TOTALE|IMPORTO\s*TOTALE|CONTANTE|RESTO|CARTA|BANCOMAT|PAGAMENTO|IVA|IMPOSTA|DOCUMENTO\s+COMMERCIALE|SCONTRINO\s+FISCALE|OPERATORE|CASSA|CASSIERE|GRAZIE|ARRIVEDERCI|SUBTOTAL|TOTAL|CASH|CHANGE|VAT|TAX|THANK\s+YOU)\b/i;
